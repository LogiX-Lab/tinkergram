                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-12 col-xs-12">
                            <div class="navbar-header text-center">
                                <a href="/home" class="navbar-brand tv-citreat-logo">Food Fusion</a>
                        ...
                        <div class="col-md-8 col-sm-12 col-xs-12">
                            <div class="collapse navbar-collapse" id="tv-navbar">
                                <ul class="nav navbar-nav text-center tv-small-bg tv-active-menu">
                                    ...
                                    <li class=""><a href="{{ route('myfood.index') }}" class="tv-menu">Share New Food</a></li>
                                     @guest
                                    <li class="tv-drop-menu">
                                    ...
                                    @else
                                    <li class=""><a href="{{ route('logout') }}" class="tv-menu"
